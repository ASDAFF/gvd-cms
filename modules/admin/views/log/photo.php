...
$this->title = 'Логи работы с фото в фотогалерее | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Логи работы с фото в фотогалерее</h1>
        <p class="page-subtitle">Информация о создании, редактировании и удалении фото в фотогалерее.</p>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<ol class="breadcrumb">
    ...
    <li>Логи</li>
    <li>Фотогалерея</li>
    <li class="active">Работа с фото</li>
</ol>
...
<div class="row">
    <div class="col-md-12">
        ...
        <a class="btn btn-danger" href="<?= Url::to(['/admin/log/clear', 'cl' => \app\modules\photo\models\Photo::className()]) ?>"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;&nbsp; Очистить логи</a><br><br>
        <?php } ?>
                            ...
                            <table class="table  dataTable no-footer dtr-inline" id="dataTables-log-news" role="grid" aria-describedby="dataTables-log-news_info" style="width: 966px;">
                                ...
                                <?php foreach ($logs as $key => $log) { ?>
                                    ...
                                    <tr class="<?= ($key%2) ? 'odd' : 'even' ?>" role="row">
                                        <td>
                                            <?php if ($log->item_id != null && $log->photo != null) { ?>
                                                <?= $log->photo ? '<a href="'.Url::to(['/admin/photo/update-photo', 'id' => $log->item_id]).'" target="_blank"><img src="'.$log->photo->photo.'" alt="" class="img-responsive"></a>' : null ?>
                                            <?php } else { ?>
