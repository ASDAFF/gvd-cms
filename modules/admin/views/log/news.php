...
$this->title = 'Логи работы с новостями | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Логи работы с новостями</h1>
        <p class="page-subtitle">Информация о создании, редактировании и удалении новостей.</p>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<ol class="breadcrumb">
    ...
    <li>Логи</li>
    <li class="active">Работа с новостями</li>
</ol>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php if (Yii::$app->user->can('root')) { ?>
            <a class="btn btn-danger" href="<?= Url::to(['/admin/log/clear', 'cl' => \app\modules\news\models\News::className()]) ?>"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;&nbsp; Очистить логи</a><br><br>
        <?php } ?>
                                    ...
                                    <tr class="<?= ($key%2) ? 'odd' : 'even' ?>" role="row">
                                        <td>
                                            <?php if ($log->item_id != null) { ?>
                                                <?= $log->news ? '<a href="'.Url::to(['/news/item', 'id' => $log->news->news_id]).'" target="_blank">'.$log->news->title.'</a>' : null ?>
                                            <?php } else { ?>
                                                <?= $log->item_name ?>
                                            <?php } ?>
                                        </td>
