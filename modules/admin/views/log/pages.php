...
$this->title = 'Логи работы со страницами | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Логи работы со страницами</h1>
        <p class="page-subtitle">Информация о создании, редактировании и удалении страниц.</p>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<ol class="breadcrumb">
    ...
    <li>Логи</li>
    <li class="active">Работа со страницами</li>
</ol>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php if (Yii::$app->user->can('root')) { ?>
            <a class="btn btn-danger" href="<?= Url::to(['/admin/log/clear', 'cl' => \app\modules\pages\models\Page::className()]) ?>"><i class="fa fa-trash-o"></i>&nbsp;&nbsp;&nbsp; Очистить логи</a><br><br>
        <?php } ?>
                                    ...
                                    <tr class="<?= ($key%2) ? 'odd' : 'even' ?>" role="row">
                                        <td>
                                            <?php if ($log->item_id != null) { ?>
                                                <?= $log->page ? '<a href="'.Url::to(['/admin/pages/update', 'id' => $log->page->page_id]).'" target="_blank">'.$log->page->title.'</a>' : $log->item_name ?>
                                            <?php } else { ?>
                                                <?= $log->item_name ?>
                                            <?php } ?>
                                        </td>
