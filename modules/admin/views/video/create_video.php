...
$this->title = 'Добавление видео в видеогалерее | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Добавление видео в видеогалерее</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<ol class="breadcrumb">
    ...
    <li class="active">Добавление видео</li>
</ol>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="preview_img well memberblock" data-input="video-image">
                    <div><a class="memmbername delete_img_preview" href="#" data-input="video-image">удалить</a></div>
                </div>
            </div>
            <div class="col-md-3">
