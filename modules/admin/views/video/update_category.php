...
$this->title = 'Редактирование категории в видеогалерее | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Редактирование категории "<?= $model->title ?>" в видеогалерее</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="preview_img well memberblock" data-input="videocategory-image">
                                <div<?= $model->cover ? ' style="background-image: url('.$model->cover.');"' : null ?>><a class="memmbername delete_img_preview" href="#" data-input="videocategory-image">удалить</a></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="preview_img icon_preview well memberblock" data-input="videocategory-icon_img">
                                <div<?= $model->icon ? ' style="background-image: url('.$model->icon.');"' : null ?>><a class="memmbername delete_img_preview" href="#" data-input="videocategory-icon_img">удалить</a></div>
                            </div>
                        </div>
                        <div class="col-md-6">
