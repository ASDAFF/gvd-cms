...
$this->title = 'Добавление слайда | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Добавление слайда</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="preview_img well memberblock" data-input="slideritem-image">
                            <div><a class="memmbername delete_img_preview" href="#" data-input="slideritem-image">удалить</a></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="preview_img icon_preview well memberblock" data-input="slideritem-icon_img">
                                <div><a class="memmbername delete_img_preview" href="#" data-input="slideritem-icon_img">удалить</a></div>
                            </div>
                        </div>
                        <div class="col-md-6">
