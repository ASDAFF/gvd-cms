...
$this->title = 'Добавление фото в фотогалерее | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Добавление фото в фотогалерее</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="preview_img well memberblock" data-input="photo-image">
                    <div><a class="memmbername delete_img_preview" href="#" data-input="photo-image">удалить</a></div>
                </div>
            </div>
            <div class="col-md-3">
