...
$this->title = 'Редактирование поля | Панель управления';
...
<div class="row">
    <div class="col-md-12  header-wrapper" >
        <h1 class="page-header">Редактирование поля "<?= $model->title ?>" страницы "<?= $page->title ?>"</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<ol class="breadcrumb">
    ...
    <li class="active">Редактирование поля</li>
</ol>
